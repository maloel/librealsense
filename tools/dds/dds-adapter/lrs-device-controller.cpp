                ...
                if( auto strong_sensor = weak_sensor.lock() )
                {
                    ...
                    for( auto changed_option : options )
                    {
                        ...
                        case RS2_OPTION_TYPE_FLOAT:
                            option_values[stream_name][option_name] = changed_option->as_float;
                            break;
                        case RS2_OPTION_TYPE_STRING:
                            option_values[stream_name][option_name] = changed_option->as_string;
                            break;
                        case RS2_OPTION_TYPE_NUMBER:
                            option_values[stream_name][option_name] = changed_option->as_number_signed;
                            break;
                        default:
