...
PYBIND11_MODULE(NAME, m) {
    ...
    //py::enum_< json_type >( m, "json_type" )
    //    .value( "null", json_type::null )
    //    .value( "object", json_type::object )
    //    .value( "array", json_type::array )
    //    .value( "string", json_type::string )
    //    .value( "boolean", json_type::boolean )
    //    .value( "integer", json_type::number_integer )
    //    .value( "unsigned", json_type::number_unsigned )
    //    .value( "float", json_type::number_float )
    //    .value( "binary", json_type::binary )
    //    .value( "discarded", json_type::discarded );
    struct json_w
    {
        json j;
    };
...
#if 0
    using realdds::dds_float_option;
    py::class_< dds_float_option, std::shared_ptr< dds_float_option > >( option, "float", option_base )
        .def( py::init< std::string const &,
              float,
              float, float, float,
              float,
              std::string const &,
              dds_option::option_properties const & >(),
              "name"_a,
              "value"_a,
              "min"_a, "max"_a, "step"_a,
              "default-value"_a,
              "description"_a = std::string(),
              py::arg( "properties" ) = dds_option::option_properties() )
        //.def( py::init<>(
        //          []( std::string const & name,
        //              float const_value,
        //              std::string const & description,
        //              dds_option::option_properties const & props )
        //          {
        //              return std::make_shared< dds_float_option >( name,
        //                                                           const_value,
        //                                                           const_value,
        //                                                           const_value,
        //                                                           0.f,
        ...
        //      "description"_a = std::string(),
        //      py::arg( "properties" ) = dds_option::option_properties() )
        .def( "set_value", &dds_float_option::set_value )
        .def( "get_minimum_value", &dds_float_option::get_minimum_value )
        .def( "get_maximum_value", &dds_float_option::get_maximum_value )
        .def( "get_stepping", &dds_float_option::get_stepping );
#endif
