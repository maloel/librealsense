...
namespace librealsense
{
        ...
        const std::vector<platform::uvc_device_info>& all_device_infos)
    {
        ...
        std::unique_ptr<frame_timestamp_reader> timestamp_reader_backup( new ds_timestamp_reader( ctx->get_time_service() ) );
        ...
        const std::vector<platform::uvc_device_info>& all_device_infos)
    {
        ...
        std::unique_ptr<frame_timestamp_reader> d400_timestamp_reader_backup( new ds_timestamp_reader( ctx->get_time_service() ) );
